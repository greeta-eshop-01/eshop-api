...
public class SecurityConfig {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .requestMatchers(HttpMethod.POST, "/catalog/*").hasRole(EshopRole.Admin)
        .requestMatchers(HttpMethod.PUT, "/catalog/*").hasRole(EshopRole.Admin)
        .requestMatchers(HttpMethod.DELETE, "/catalog/*").hasRole(EshopRole.Admin)
        .and()
