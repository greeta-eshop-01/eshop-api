...
public class SecurityConfig {
  ...
  SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http
      .securityMatcher("/basket/**")
      .authorizeRequests()
      .requestMatchers(HttpMethod.GET, "/basket/*").hasAuthority(scope(BASKET_SCOPE))
      .requestMatchers(HttpMethod.POST, "/basket/*").hasAuthority(scope(BASKET_SCOPE))
      .requestMatchers(HttpMethod.PUT, "/basket/*").hasAuthority(scope(BASKET_SCOPE))
      .requestMatchers(HttpMethod.DELETE, "/basket/*").hasAuthority(scope(BASKET_SCOPE))
      .and()
